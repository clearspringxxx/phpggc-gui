...
class QBasicReadWriteLock(Shiboken.Object):
    ...
    def contendedTryLockForRead(self, timeout: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int, dd: int, /) -> bool: ...
    def contendedTryLockForWrite(self, timeout: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int, dd: int, /) -> bool: ...
    def contendedUnlock(self, dd: int, /) -> None: ...
    def isContendedLockForRead(self, dd: int, /) -> bool: ...
    def lock(self, /) -> None: ...
    ...
    def tryLockForReadInternal(self, timeout: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int, tsanFlags: int, /) -> bool: ...
    @typing.overload
    ...
    def tryLockForWriteInternal(self, timeout: PySide6.QtCore.QDeadlineTimer | PySide6.QtCore.QDeadlineTimer.ForeverConstant | int, tsanFlags: int, /) -> bool: ...
    def try_lock(self, /) -> bool: ...
...
class QFutureInterfaceBase(Shiboken.Object):
    ...
    def isAddResultsIfCanceledEnabled(self, /) -> bool: ...
    ...
    def setAddResultsIfCanceledEnabled(self, enable: bool, /) -> None: ...
...
class QJsonArray(Shiboken.Object):
    ...
    def toObjectList(self, /) -> typing.List[typing.Dict[str, PySide6.QtCore.QJsonValue]]: ...
    def toVariantList(self, /) -> typing.List[typing.Any]: ...
...
class QJsonValue(Shiboken.Object):
    ...
    def __eq__(self, rhs: PySide6.QtCore.QJsonArray, /) -> bool: ...
    @typing.overload
    def __eq__(self, rhs: typing.Dict[str, PySide6.QtCore.QJsonValue], /) -> bool: ...
    @typing.overload
    def __eq__(self, rhs: typing.Union[PySide6.QtCore.QJsonValue, PySide6.QtCore.QJsonValue.Type, str, bool, PySide6.QtCore.QJsonArray, typing.Dict[str, PySide6.QtCore.QJsonValue], bytes, bytearray, memoryview, float, int], /) -> bool: ...
    def __hash__(self, /) -> int: ...
    @typing.overload
    def __ne__(self, rhs: PySide6.QtCore.QJsonArray, /) -> bool: ...
    @typing.overload
    def __ne__(self, rhs: typing.Dict[str, PySide6.QtCore.QJsonValue], /) -> bool: ...
    @typing.overload
    def __ne__(self, rhs: typing.Union[PySide6.QtCore.QJsonValue, PySide6.QtCore.QJsonValue.Type, str, bool, PySide6.QtCore.QJsonArray, typing.Dict[str, PySide6.QtCore.QJsonValue], bytes, bytearray, memoryview, float, int], /) -> bool: ...
    def __repr__(self, /) -> str: ...
    @staticmethod
...
class QLocale(Shiboken.Object):
    ...
    def __copy__(self, /) -> typing.Self: ...
    @typing.overload
    def __eq__(self, rhs: PySide6.QtCore.QLocale.Language, /) -> bool: ...
    @typing.overload
    def __eq__(self, rhs: PySide6.QtCore.QLocale | PySide6.QtCore.QLocale.Language, /) -> bool: ...
    def __hash__(self, /) -> int: ...
    @typing.overload
    def __ne__(self, rhs: PySide6.QtCore.QLocale.Language, /) -> bool: ...
    @typing.overload
...
class QMargins(Shiboken.Object):
    ...
    @typing.overload
    def __itruediv__(self, arg__1: int, /) -> PySide6.QtCore.QMargins: ...
    @typing.overload
    def __itruediv__(self, arg__1: float, /) -> PySide6.QtCore.QMargins: ...
    @typing.overload
    ...
    @typing.overload
    def __truediv__(self, divisor: int, /) -> PySide6.QtCore.QMargins: ...
    @typing.overload
    def __truediv__(self, divisor: float, /) -> PySide6.QtCore.QMargins: ...
    def bottom(self, /) -> int: ...
    def isNull(self, /) -> bool: ...
    def left(self, /) -> int: ...
    def right(self, /) -> int: ...
...
class QMarginsF(Shiboken.Object):
    ...
    def __itruediv__(self, divisor: float, /) -> PySide6.QtCore.QMarginsF: ...
    ...
    def __truediv__(self, divisor: float, /) -> PySide6.QtCore.QMarginsF: ...
...
class QPoint(Shiboken.Object):
    ...
    def __itruediv__(self, divisor: float, /) -> PySide6.QtCore.QPoint: ...
    @typing.overload
    ...
    def __truediv__(self, c: float, /) -> PySide6.QtCore.QPoint: ...
    @staticmethod
...
class QPointF(Shiboken.Object):
    ...
    def __itruediv__(self, c: float, /) -> PySide6.QtCore.QPointF: ...
    ...
    def __truediv__(self, divisor: float, /) -> PySide6.QtCore.QPointF: ...
    @staticmethod
...
class QRangeModel(PySide6.QtCore.QAbstractItemModel):
    ...
    @typing.overload
    def __init__(self, data: collections.abc.Sequence[typing.Any], /, parent: PySide6.QtCore.QObject | None = ..., *, roleNames: typing.Optional[typing.Dict[int, PySide6.QtCore.QByteArray]] = ..., autoConnectPolicy: PySide6.QtCore.QRangeModel.AutoConnectPolicy | None = ...) -> None: ...
    @typing.overload
    def __init__(self, list: collections.abc.Iterable, /, parent: PySide6.QtCore.QObject | None = ..., *, roleNames: typing.Optional[typing.Dict[int, PySide6.QtCore.QByteArray]] = ..., autoConnectPolicy: PySide6.QtCore.QRangeModel.AutoConnectPolicy | None = ...) -> None: ...

    def autoConnectPolicy(self, /) -> PySide6.QtCore.QRangeModel.AutoConnectPolicy: ...
    def buddy(self, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /) -> PySide6.QtCore.QModelIndex: ...
    def canDropMimeData(self, data: PySide6.QtCore.QMimeData, action: PySide6.QtCore.Qt.DropAction, row: int, column: int, parent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /) -> bool: ...
    def canFetchMore(self, parent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /) -> bool: ...
    def clearItemData(self, index: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex, /) -> bool: ...
    ...
    def roleNames(self, /) -> typing.Dict[int, PySide6.QtCore.QByteArray]: ...
    def rowCount(self, /, parent: PySide6.QtCore.QModelIndex | PySide6.QtCore.QPersistentModelIndex = ...) -> int: ...
    def setAutoConnectPolicy(self, policy: PySide6.QtCore.QRangeModel.AutoConnectPolicy, /) -> None: ...
...
class QSize(Shiboken.Object):
    ...
    def __itruediv__(self, c: float, /) -> PySide6.QtCore.QSize: ...
    ...
    def __truediv__(self, c: float, /) -> PySide6.QtCore.QSize: ...
...
class QSizeF(Shiboken.Object):
    ...
    def __itruediv__(self, c: float, /) -> PySide6.QtCore.QSizeF: ...
    ...
    def __truediv__(self, c: float, /) -> PySide6.QtCore.QSizeF: ...
...
class QTemporaryFile(PySide6.QtCore.QFile):
    ...
    def renameOverwrite(self, newName: str, /) -> bool: ...
    def setAutoRemove(self, b: bool, /) -> None: ...
...
class QTextBoundaryFinder(Shiboken.Object):
    ...
    def string(self, /) -> str: ...
    def swap(self, other: PySide6.QtCore.QTextBoundaryFinder, /) -> None: ...
    def toEnd(self, /) -> None: ...
...
def qInstallMessageHandler(callable: collections.abc.Callable[[PySide6.QtCore.QtMsgType, PySide6.QtCore.QMessageLogContext, str], typing.Any] | None, /) -> collections.abc.Callable[[PySide6.QtCore.QtMsgType, PySide6.QtCore.QMessageLogContext, str], typing.Any] | None: ...
