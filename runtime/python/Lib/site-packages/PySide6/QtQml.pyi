...
class QJSPrimitiveValue(Shiboken.Object):
    ...
    def __truediv__(self, rhs: PySide6.QtQml.QJSPrimitiveValue | str | bool | float | int, /) -> PySide6.QtQml.QJSPrimitiveValue: ...
...
class QQmlComponent(PySide6.QtCore.QObject):
    ...
    def createWithInitialProperties_withownership(self, initialProperties: typing.Dict[str, typing.Any], /) -> PySide6.QtCore.QObject: ...
    def create_withownership(self, /, context: PySide6.QtQml.QQmlContext | None = ...) -> PySide6.QtCore.QObject: ...
...
class QQmlContext(PySide6.QtCore.QObject):
    ...
    def childContexts(self, /) -> typing.List[PySide6.QtQml.QQmlContext]: ...
    def contextObject(self, /) -> PySide6.QtCore.QObject: ...
    def contextProperty(self, arg__1: str, /) -> typing.Any: ...
    def engine(self, /) -> PySide6.QtQml.QQmlEngine: ...
    def findObjectRecursively(self, id: str, /) -> PySide6.QtCore.QObject: ...
    def findObjectsRecursively(self, id: str, /) -> typing.List[PySide6.QtCore.QObject]: ...
...
class QQmlPropertyMap(PySide6.QtCore.QObject):
    ...
    def count(self, /) -> int: ...
    @staticmethod
    def create(parent: PySide6.QtCore.QObject | None = ...) -> PySide6.QtQml.QQmlPropertyMap: ...
...
def QmlAnonymous(arg__1: _QmlType, /) -> _QmlType: ...
def QmlElement(arg__1: _QmlType, /) -> _QmlType: ...
def QmlSingleton(arg__1: _QmlType, /) -> _QmlType: ...
