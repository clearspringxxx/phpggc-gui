...
class QQuickWindow(PySide6.QtGui.QWindow):
    ...
    @typing.overload
    def __init__(self, renderControl: PySide6.QtQuick.QQuickRenderControl, /, *, color: PySide6.QtGui.QColor | None = ..., contentItem: PySide6.QtQuick.QQuickItem | None = ..., activeFocusItem: PySide6.QtQuick.QQuickItem | None = ..., devicePixelRatio: float | None = ...) -> None: ...
    @typing.overload
    def __init__(self, /, parent: PySide6.QtGui.QWindow | None = ..., *, color: PySide6.QtGui.QColor | None = ..., contentItem: PySide6.QtQuick.QQuickItem | None = ..., activeFocusItem: PySide6.QtQuick.QQuickItem | None = ..., devicePixelRatio: float | None = ...) -> None: ...
...
class QSGMaterialShader(Shiboken.Object):
    ...
    class GraphicsPipelineState(Shiboken.Object):
        ...
        colorWrite                = ...  # type: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.ColorMaskComponent
        cullMode                  = ...  # type: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.CullMode
        dstAlpha                  = ...  # type: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendFactor
        dstColor                  = ...  # type: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendFactor
        opAlpha                   = ...  # type: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendOp
        opColor                   = ...  # type: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendOp
        polygonMode               = ...  # type: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.PolygonMode
        separateBlendFactors      = ...  # type: bool
        srcAlpha                  = ...  # type: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendFactor
        srcColor                  = ...  # type: PySide6.QtQuick.QSGMaterialShader.GraphicsPipelineState.BlendFactor
...
class QSGOpaqueTextureMaterial(PySide6.QtQuick.QSGMaterial):
    m_anisotropy_level        = ...  # type: int
    m_filtering               = ...  # type: int
    m_horizontal_wrap         = ...  # type: int
    m_mipmap_filtering        = ...  # type: int
    m_reserved                = ...  # type: int
    m_texture                 = ...  # type: PySide6.QtQuick.QSGTexture
    m_vertical_wrap           = ...  # type: int
