...
class QCanvasGradient(PySide6.QtCanvasPainter.QCanvasBrush):
    ...
    def setStops(self, stops: collections.abc.Sequence[PySide6.QtCanvasPainter.QCanvasGradientStop], /) -> None: ...
    def startColor(self, /) -> PySide6.QtGui.QColor: ...
    def stops(self, /) -> typing.List[PySide6.QtCanvasPainter.QCanvasGradientStop]: ...
    def type(self, /) -> PySide6.QtCanvasPainter.QCanvasBrush.BrushType: ...
...
class QCanvasGradientStop(Shiboken.Object):
    ...
    def __init__(self, /) -> None: ...
    @typing.overload
    def __init__(self, QCanvasGradientStop: PySide6.QtCanvasPainter.QCanvasGradientStop, /) -> None: ...

    def __copy__(self, /) -> typing.Self: ...
    def __eq__(self, rhs: PySide6.QtCanvasPainter.QCanvasGradientStop, /) -> bool: ...
    def __lshift__(self, arg__1: PySide6.QtCore.QDataStream, /) -> PySide6.QtCore.QDataStream: ...
    def __ne__(self, rhs: PySide6.QtCanvasPainter.QCanvasGradientStop, /) -> bool: ...
    def __repr__(self, /) -> str: ...
    def __rshift__(self, arg__1: PySide6.QtCore.QDataStream, /) -> PySide6.QtCore.QDataStream: ...
